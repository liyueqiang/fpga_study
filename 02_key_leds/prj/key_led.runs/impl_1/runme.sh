...
HD_PWD='E:/FPGA/fpga_study/02_key_leds/prj/key_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log key_leds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source key_leds.tcl -notrace
