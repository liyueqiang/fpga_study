...
HD_PWD='E:/FPGA/fpga_study/02_key_leds/prj/key_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log key_leds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source key_leds.tcl
